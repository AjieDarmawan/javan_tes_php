...
<div class="container pt-5">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb ">
                <li class="breadcrumb-item"><a>Banner</a></li>
                <li class="breadcrumb-item active" aria-current="page">List Data</li>
            </ol>
        </nav>
        <div class="row">
            <div class="col-md-12">
                <!-- <a class="btn btn-primary mb-2" href="<?= base_url('master/Banner/tambah'); ?>">Tambah</a> -->
                <div mb-2>
    ...
    <script>
        ...
        $('#tabledivisi').DataTable({
            ...
            "ajax": {
                ...
                "url": '<?php echo base_url('master/Testimoni/ajax_list')?>',
                "type": "POST"
            }
        });
    </script>
      ...
      $(document).on("click",".hapus_dokumen",function(){
            ...
            //  alert(id);
              swal({
                  ...
                  $.ajax({
                      type : "POST",
                      url  : "<?php echo base_url();?>master/Testimoni/hapus",
                      dataType: "JSON",
                      data : "id="+id,
