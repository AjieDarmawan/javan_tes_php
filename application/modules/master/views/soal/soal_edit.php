                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-8">
                                    <select name="jawaban_benar" class="form-control">
                                            ...
                                            <option value="1" <?php if($soal->jawaban=='1'){echo "selected";}?> >A</option>
                                            <option value="2" <?php if($soal->jawaban=='2'){echo "selected";}?>>B</option>
                                            <option value="3" <?php if($soal->jawaban=='3'){echo "selected";}?>>C</option>
                                            <option value="4" <?php if($soal->jawaban=='4'){echo "selected";}?>>D</option>
                                            <option value="5" <?php if($soal->jawaban=='5'){echo "selected";}?>>E</option>
                                    </select>
                                </div>
