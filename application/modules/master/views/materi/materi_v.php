<div class="container pt-5">
        ...
        <div class="row">
            <div class="col-md-12">
                <a class="btn btn-primary mb-2" href="<?= base_url('master/materi/tambah/'.$id); ?>">Tambah</a>
                <div mb-2>
    ...
    <script>
        ...
        $('#tabledivisi').DataTable({
            ...
            "ajax": {
                ...
                "url": '<?php echo base_url('master/materi/ajax_list/'.$id)?>',
                "type": "POST"
            }
        });
    </script>
      ...
      $(document).on("click",".hapus_dokumen",function(){
            ...
            //  alert(id);
              swal({
                  ...
                  $.ajax({
                      type : "POST",
                      url  : "<?php echo base_url();?>master/materi/hapus",
                      dataType: "JSON",
                      data : "id="+id,
