...
<div class="container pt-5">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb ">
                <li class="breadcrumb-item"><a>Event</a></li>
                <li class="breadcrumb-item active" aria-current="page">List Data Event</li>
            </ol>
        </nav>
        <div class="row">
            <div class="col-md-12">
                <!-- <a class="btn btn-primary mb-2" href="<?= base_url('master/Paket/tambah'); ?>">Tambah</a> -->
                <div mb-2>
    ...
    <script>
        ...
        $('#tabledivisi').DataTable({
            ...
            "ajax": {
                ...
                "url": '<?php echo base_url('master/Paket/ajax_list_event_paket/'.$id_paket)?>',
                "type": "POST"
            }
        });
    </script>
      ...
      $(document).on("click",".hapus_dokumen",function(){
            ...
            //  alert(id);
              swal({
                  ...
                  $.ajax({
                      type : "POST",
                      url  : "<?php echo base_url();?>master/Paket/hapus",
                      dataType: "JSON",
                      data : "id="+id,
