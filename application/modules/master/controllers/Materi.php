...
class Materi extends CI_Controller
{
    ...
    public function ajax_list($id)
    {
        ...
        foreach ($list as $data_Materi) {
            ...
            if($m->publish==1){
                $publsih = "<a data-toggle='tooltip' readonly title='publish soal'  href=".base_url('master/Materi/publish/'.base64_encode($data_Materi->materi_id)).'/'.$id."><button disabled class='btn btn-primary btn-xs'><i class='fa fa-home'></i></button></a>";
          ...
          foreach($rowData as $c => $key){
             $no_b = $kosong_b++;
                if($key[0][6]!='pilihan B'){
                    ...
                    if($key[0][6]==null){
                        $a =   $img_gambar_tes_jawaban_b[$no_b];
                    }else{
                        $a = "";
                    }
          ...
          foreach($rowData as $c => $key){
            ...
            // print_r($key);
                ...
                if($key[0][7]!='pilihan C'){
                    ...
                    if($key[0][7]==null){
                        $a =   $img_gambar_tes_jawaban_c[$no_c];
                    }else{
                        $a = "";
                    }
          ...
          foreach($rowData as $c => $key){
             $no_d = $kosong_d++;
                ...
                if($key[0][8]!='pilihan D'){
                    ...
                    if($key[0][8]==null){
                        $a =   $img_gambar_tes_jawaban_d[$no_d];
                    }else{
                        $a = "";
                    }
          ...
          foreach($rowData as $c => $key){
              ...
              $no_e = $kosong_e++;
                ...
                if($key[0][9]!='pilihan E'){
                    ...
                    if($key[0][9]==null){
                        $a =   $img_gambar_tes_jawaban_e[$no_e];
                    }else{
                        $a = "";
                    }
    ...
    function update_simpan(){
        ...
        $simpan = $this->Materi_M->update($Materi_id,$Materi_nama,$no_urut,$id_jenis,$waktu);
