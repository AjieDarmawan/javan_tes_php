        ...
        <div class="col-md-12">
            ...
            <div mb-2>
                ...
                <form>
                    ...
                    <a class="btn btn-success btn-sm" href="<?= base_url('report/pendaftar_webinar/print/' . $tanggal_awal . '/' . $tanggal_akhir); ?>"  >Print</a>
                </form>
...
<script>
    ...
    $('#tabledivisi').DataTable({
        ...
        "ajax": {
            ...
            "url": '<?php echo base_url('report/Pendaftar_webinar/ajax_list/'.$tanggal_awal.'/'.$tanggal_akhir) ?>',
            "type": "POST"
        }
    });
</script>